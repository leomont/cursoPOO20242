...
public class AccountTest {
   public static void main(String[] args) {
      ...
      //Debit Amount
      System.out.println("Ingrese el valor que desea retirar de la cuenta 1: ");
      Double debitAmount = input.nextDouble();
      System.out.printf("%nretirando %.2f de la cuenta 1 %n%n", debitAmount);
      account1.debit(debitAmount);

      System.out.println("Ingrese el valor que desea retirar de la cuenta 2: ");
      debitAmount = input.nextDouble();
      System.out.printf("%nretirando %.2f de la cuenta 2 %n%n", debitAmount);
